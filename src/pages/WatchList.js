...
const WatchList1 = () => {
  ...
  const fetchStocks = async () => {
    try {
      const response = await axios.get('https://ashish-backend-myql.onrender.com/api/watchlist1');
  ...
  const fetchBalance = async () => {
    ...
    try {
      const response = await axios.get(`https://ashish-backend-myql.onrender.com/api/users/balance/${userId}`);
  ...
  const handleBuy = async () => {
    ...
    try {
      const response = await axios.post('https://ashish-backend-myql.onrender.com/api/watchlist1/buy', {
